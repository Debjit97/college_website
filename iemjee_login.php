...
<title>IEMJEE student login</title>
...
<form  action="iemjee_login.php" method="post">
	  ...
	  <div class="row content">   
		  ...
		  <div class="col-sm-12">
			  <div class="panel panel-primary">
	      		<div class="panel-heading"><b>Sign - In  [IEMJEE Registered Student] </b></div>
	      		<div class="panel-body" style="margin-bottom:-5px;">
		      		<label for="pwd">
				   	<span class="glyphicon glyphicon-user"></span>
				  	Enter the email-id.
				  	</label>		    
				    <input type="text" class="form-control" id="usr" name="t1" placeholder="Enter your email id." required="required">
	      		</div>
	      		...
	      		<div class="panel-body" style="margin-bottom:-5px;">
				 	...
				 	Password:		  
				  	...
				  	<input type="password" class="form-control" id="pwd" name="t2" placeholder="Your Password" required>
	      		</div>
