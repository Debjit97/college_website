<?php session_start();
			...
			if(isset($_POST["btn"]))
			{
				...
				{
					$sql="select * from admin_login where admin_id='".$user."' and password='".$pass."'";
	  ...
	  <div class="row content">   
		  ...
		  <div class="col-sm-12">
			  <div class="panel panel-primary">
	      		<div class="panel-heading"><b>Sign - In  [Administrator] </b></div>
	      		<div class="panel-body" style="margin-bottom:-5px;">
		      		<label for="pwd">
				   	<span class="glyphicon glyphicon-user"></span>
				  	Administrator ID.
				  	</label>		    
				    <input type="text" class="form-control" id="usr" name="t1" placeholder="Enter your id" required="required">
	      		</div>
